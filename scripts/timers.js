...
function toggleTimer0() {
	...
	if ( (hh >= 0 && hh < 24) && (mm >= 0 && mm < 60) && (ss >=0 && ss < 60)) {
		...
		webiopi().callMacro("setTimer0On", timer, []);
	}
	...
	if ( hh >= 0 && hh < 24 && mm >= 0 && mm < 60 && ss >=0 && ss < 60) {
		timer = hh * 3600 + mm * 60 + ss;	
		webiopi().callMacro("setTimer0Off", timer, []);
	}
	if ($("#bt_timer0").text() == "On") {
		webiopi().callMacro("disableTimer", 0, []);
	}		
	else {
		webiopi().callMacro("enableTimer", 0, []);
	}
	updateUI();
}
...
function toggleTimer1() {
	...
	if ( (hh >= 0 && hh < 24) && (mm >= 0 && mm < 60) && (ss >=0 && ss < 60)) {
		timer = hh * 3600 + mm * 60 + ss;	
		webiopi().callMacro("setTimer1On", timer, []);
	}
	...
	if ( hh >= 0 && hh < 24 && mm >= 0 && mm < 60 && ss >=0 && ss < 60) {
		timer = hh * 3600 + mm * 60 + ss;	
		webiopi().callMacro("setTimer1Off", timer, []);
	}
	if ($("#bt_timer1").text() == "On") {
		webiopi().callMacro("disableTimer", 1, []);
	}		
	else {
		webiopi().callMacro("enableTimer", 1, []);
	}
	updateUI();
}
...
function toggleTimer2() {
	...
	if ( (hh >= 0 && hh < 24) && (mm >= 0 && mm < 60) && (ss >=0 && ss < 60)) {
		timer = hh * 3600 + mm * 60 + ss;	
		webiopi().callMacro("setTimer2On", timer, []);
	}
	...
	if ( hh >= 0 && hh < 24 && mm >= 0 && mm < 60 && ss >=0 && ss < 60) {
		timer = hh * 3600 + mm * 60 + ss;	
		webiopi().callMacro("setTimer2Off", timer, []);
	}
	if ($("#bt_timer2").text() == "On") {
		webiopi().callMacro("disableTimer", 2, []);
	}		
	else {
		webiopi().callMacro("enableTimer", 2, []);
	}
	updateUI();
}
...
function toggleTimer3() {
	...
	if ( (hh >= 0 && hh < 24) && (mm >= 0 && mm < 60) && (ss >=0 && ss < 60)) {
		timer = hh * 3600 + mm * 60 + ss;	
		webiopi().callMacro("setTimer3On", timer, []);
	}
	...
	if ( hh >= 0 && hh < 24 && mm >= 0 && mm < 60 && ss >=0 && ss < 60) {
		timer = hh * 3600 + mm * 60 + ss;	
		webiopi().callMacro("setTimer3Off", timer, []);
	}
	if ($("#bt_timer3").text() == "On") {
		webiopi().callMacro("disableTimer", 3, []);
	}		
	else {
		webiopi().callMacro("enableTimer", 3, []);
	}
	updateUI();
}
